...
use super::{
    AbiParam, AbiStateMutability, AllEndpoints, ApiData, ApiDataAnchor, ArgCodeType, CheckFunction, CheckedCodeItem,
    CodeContent, CodeData, CodeDataAnchor, CodeItem, CodeType, CodeValue, ComponentId, EvmCallApi, InputValue,
    LinkError, LinkType,
};
...
impl EvmActionCall {
    ...
    pub fn check<F: CheckFunction>(
        ...
        if !matches!(state_mutability, AbiStateMutability::Pure | AbiStateMutability::View) {
